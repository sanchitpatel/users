  ...
  return (
    <footer className="site-footer" id="support">
      <div className="footer-grid">
        <div className="footer-info">
          <div className="logo" style={{ border: 'none', padding: 0 }}>
            ...
            <span>{tenant.brandName}</span>{tenant.country}
          </div>
          ...
          <div className="footer-contacts">
            ...
            <div className="contact-item">
              ...
              <a href={`tel:${tenant.phoneRaw}`}>{tenant.phone}</a>
            </div>
          ...
          <div className="footer-socials">
            {/* Instagram */}
            <a href={tenant.instagram} target="_blank" rel="noopener noreferrer" className="social-btn" aria-label="Instagram">
            ...
            {/* Facebook */}
            <a href={tenant.facebook} target="_blank" rel="noopener noreferrer" className="social-btn" aria-label="Facebook">
              <svg viewBox="0 0 24 24">
            ...
            {/* YouTube */}
            <a href={tenant.youtube} target="_blank" rel="noopener noreferrer" className="social-btn" aria-label="YouTube">
              <svg viewBox="0 0 24 24">
            ...
            {/* WhatsApp */}
            <a href={`https://wa.me/${tenant.whatsapp}`} target="_blank" rel="noopener noreferrer" className="social-btn" aria-label="WhatsApp">
              <svg viewBox="0 0 24 24">
      ...
      <div className="footer-bottom">
        <p>&copy; {currentYear} {tenant.brandName}. All rights reserved.</p>
        <p>Expert Third-Party Repair Center | {tenant.city}, {tenant.state}</p>
      </div>
    </footer>
  );
}
